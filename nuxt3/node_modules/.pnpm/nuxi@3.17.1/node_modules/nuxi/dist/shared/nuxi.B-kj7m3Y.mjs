...
import { c as consola, A, h as f, U } from './nuxi.BpXDZ4Tv.mjs';
import 'node:util';
import 'node:path';
import 'node:process';
import 'node:tty';
import '../chunks/satisfies.mjs';
import { f as findWorkspaceDir, r as readPackageJSON } from './nuxi.a6bzaP2S.mjs';
import { fileURLToPath } from 'node:url';
import 'node:module';
import './nuxi.BdnFVL_h.mjs';
import { r as resolvePath$1 } from './nuxi.BLjynjc6.mjs';
import { w as withoutLeadingSlash, a as withTrailingSlash } from './nuxi.bcvuOb7W.mjs';
import { i as normalizeWindowsPath, j as join, r as resolve, h as basename, g as relative, k as isAbsolute, d as dirname, n as normalize } from './nuxi.BrnifDS2.mjs';
import { readdir } from 'node:fs/promises';
import nodeCrypto from 'node:crypto';
import { s as semverExports } from './nuxi.wVjcfr_F.mjs';
import { t as tryResolveModule$1, i as importModule } from './nuxi.BAWBxh_J.mjs';
...
async function _generateTypes(nuxt) {
  ...
  const hasTypescriptVersionWithModulePreserve = await readPackageJSON("typescript", { url: nuxt.options.modulesDir }).then((r) => r?.version && semverExports.gte(r.version, "5.4.0")).catch(() => isV4);
...
export { loadKit as l, randomUUID as r, writeTypes as w };
